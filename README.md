...
[Live demo](#) · [Demo video](docs/demo-script.md) · [Architecture](docs/ARCHITECTURE.md) · [User guide](docs/USER_GUIDE.md) · [Local dev](docs/LOCAL_DEV.md)
...
│   ├── LOCAL_DEV.md          Local dev setup & debugging
